...
function buildLinkIcon() {
  ...
  s.append(
    svg.node("path", {
      ...
      // currentColor instead of a hardcoded black fill (see
      // buildNotesIcon()'s comment above for why).
      fill: "currentColor",
    }),
  );
